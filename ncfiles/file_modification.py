...
def main():
    if "linux" in platform or "darwin" in platform:
        ...
        searchpath = "C:\\"
    log = open("FILE-MODIFICATION.log", "w+")
    # Search for vCapiPy location#
    print("Looking for the location of vCapiPy environment...")
